...
requests, granting them the responsibility of managing issues and pull requests.
...
[Chakra receives large numbers of issues and pull requests each week](https://github.com/chakra-ui/chakra-ui/pulse).
...
Having an effective triage team will shield contributors from this
...
- if the feature already exists, point the user to the docs
